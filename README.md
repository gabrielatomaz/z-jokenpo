 ...
 * ##### Player
    * Jogador vence com Papel vs Pedra (V)
    * Jogador vence com Papel vs Tesoura (F)
    * Jogador vence com Pedra vs Tesoura (V)
    * Jogador vence com Pedra vs Papel (F)
    * Jogador vence com Tesoura vs Papel (V)
    * Jogador vence com Tesoura vs Pedra (n) vezes (F)
    * Jogador vence com Papel vs Pedra (n) vezes (V)
    * Jogador vence com Papel vs Tesoura (n) vezes (F)
    * Jogador vence com Pedra vs Tesoura (n) vezes (V)
    * Jogador vence com Pedra vs Papel (n) vezes (F)
    * Jogador vence com Tesoura vs Papel (n) vezes (V)
    * Jogador vence com Tesoura vs Pedra (n) vezes (F)
